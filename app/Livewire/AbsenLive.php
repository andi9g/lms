...
class AbsenLive extends Component
{
    ...
    public $idgurumapel, $idjp, $idruang, $materi, $tanggalabsen, $jamabsen;
    ...
    {
        $dataabsenpelajaran = absenpelajaranM::where(["iduser" => $this->iduser, "tanggalabsen" => date("Y-m-d")]);
        
        $gurumapel = gurumapelM::where(["iduser"=> $this->iduser, "idsemester" => Session::get("idsemester")])
        ->get();
        $ruang = ruangM::get();
        $jp = jpM::whereNotIn("idjp", $dataabsenpelajaran->pluck("idjp"))->get();
    ...
    public function absen()
    {
        ...
        $this->reset(["idgurumapel", "idjp", "idruang", "materi"]);
